...
import 'package:dartvader/src/utils.dart';
import 'package:test/test.dart';
import 'package:path/path.dart' as path;
import 'package:http/http.dart' as http;
import 'package:mongo_dart/mongo_dart.dart';
import 'utils.dart';
import 'package:dartvader/dartvader.dart';
    ...
    group('v', () {
      test('<1.0.0', () async {
        ...
        expect(res.headers[HttpHeaders.locationHeader],
            'https://img.shields.io/static/v1?label=dartvader&message=0.0.1&color=orange');
      });
      ...
      test('>=1.0.0', () async {
        ...
        expect(res.statusCode, HttpStatus.found);
        expect(res.headers[HttpHeaders.locationHeader],
            'https://img.shields.io/static/v1?label=dartvader&message=1.0.0&color=blue');
      });
