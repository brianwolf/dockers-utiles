...
import 'package:dartvader/dartvader_api/lib/models.dart';
import 'package:dartvader/src/meta_store.dart';
import 'package:dartvader/src/package_store.dart';
import 'utils.dart';
...
class App {
  ...
  ///
  /// for more details, see: https://github.com/bytedance/dartvader#package-validator
  ...
  Future<shelf.Response> upload(shelf.Request req) async {
    try {
      ...
      var dartvaderVersion = DartvaderVersion(
        version,
        pubspec,
        pubspecYaml,
        uploader,
      ...
      await metaStore.addVersion(name, dartvaderVersion);
  ...
  Future<shelf.Response> getPackageDetail(
    ...
    DartvaderVersion? packageVersion;
    if (version == 'latest') {
