...
class MongoStore extends MetaStore {
  ...
  Future<DartvaderQueryResult> _queryPackagesBySelector(
    ...
    final packages = await db
        ...
        .find(selector)
        .map((item) => DartvaderPackage.fromJson(item))
        .toList();
    return DartvaderQueryResult(count, packages);
  }
  ...
  queryPackage(name) async {
    ...
    return DartvaderPackage.fromJson(json);
  }
