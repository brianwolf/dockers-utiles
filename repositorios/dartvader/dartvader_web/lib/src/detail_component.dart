...
import 'package:dartvaderweb/app_service.dart';
import 'routes.dart';
import 'package:dartvader_api/models.dart';
...
class DetailComponent implements OnInit, OnActivate {
  ...
  String getListUrl(String q) {
    return RoutePaths.list.toUrl(queryParameters: {'q': q});
  }

  String getDetailUrl(String name, [String? version]) {
    if (version == null) {
