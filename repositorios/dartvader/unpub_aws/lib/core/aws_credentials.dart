...
class AwsCredentials {
  ...
  AwsCredentials(
    ...
    if ((isInContainer != null || containerCredentials != null) &&
      ...
      // Dart 3 no longer supports sync waiting in constructors.
      // If running in a container, pass credentials explicitly.
  ...
  Future<Map<String, String>?> getContainerCredentials(
    ...
    try {
      ...
      return (json.decode(response) as Map).cast<String, String>();
    } catch (e) {
